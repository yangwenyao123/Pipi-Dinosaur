...
import pickerColumns from "./picker-column";
export default {
  name: 'picker',
  props: {
    title: String,
  ...
  render: function render(h) {
    ...
    var columnsStyle = {
      height: "".concat(itemHeight * this.visibleItemCount, "px")
    };
    var Toolbar = this.showToolbar && h("div", {
      "class": 'nav-bar bg-white solid-bottom solid-top'
    }, [$slots.default || [h("div", {
    ...
    return h("div", {
      ...
      "class": "picker__columns",
      "style": columnsStyle,
      "on": {
        "touchmove": prevent
      }
    }, [columns.map(function (item, index) {
      return h(pickerColumns, {
        "attrs": {
